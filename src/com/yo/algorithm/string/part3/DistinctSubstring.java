package com.yo.algorithm.string.part3;
...
public class DistinctSubstring {
    public static void main(String[] args) {
        ...
        System.out.println(longestSubstringContTest(str, str.length()));
        String str2 = "aabcb";
        System.out.println(longestSubstringContTest(str2, str2.length()));
    }
    ...
    public static String longestSubstringContTest(String A, int n) {
        if(A==null || n<=0) {
            return "";
        }
        char[] chas = A.toCharArray();
