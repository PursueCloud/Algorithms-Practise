package com.yo.algorithm.binarysearch.part2;
...
public class ContNodes {
    ...
    public static int bsCount(TreeNode node,int start,int height){//start表示从头节点开始位置，height表示左子树左节点能到达的层数
        if(start == height){
            return 1;//只有一个头结点
        }
