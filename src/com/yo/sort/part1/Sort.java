...
public class Sort {
    public static void main(String[] args) {
        ...
        //print
        printArray(quickSort(data, data.length));
    }
    ...
    public static int[] bubbleSort(int[] data, int len) {
        ...
        long spend = endMillis - startMillis;
        System.out.print("冒泡排序耗时：" + spend + "ms\n");
        return data;
    }
    ...
    public static int[] selectionSort(int[] data, int len) {
        ...
        long endMillis = System.currentTimeMillis();
        long spend = endMillis - startMillis;
        System.out.print("选择排序耗时：" + spend + "ms\n");
        return data;
    }
    ...
    public static int[] insertionSort(int[] data, int len) {
        ...
        long endMillis = System.currentTimeMillis();
        long spend = endMillis - startMillis;
        System.out.print("插入排序耗时：" + spend + "ms\n");
        return data;
    }
    ...
    public static int[] mergeSort(int[] data, int len) {
        ...
        long endMillis = System.currentTimeMillis();
        long spend = endMillis - startMillis;
        System.out.print("归并排序耗时：" + spend + "ms\n");
        return data;
    }
